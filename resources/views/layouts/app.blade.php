...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!--stack permite agregar estilos que no se van a requerir en todas las vistas  styles o scripts-->
        @stack('styles')
    ...
    <body class="bg-gray-100">
      <header class="p-5 border-b bg-white shadow">
        <div class="container mx-auto flex flex-col md:flex-row justify-between items-center">
          <a href="{{ route('home') }}" class="text-3xl font-black mb-3 md:mb-0">
            DevStagram
          </a>
          ...
          @auth
            <nav class="flex flex-col gap-4 md:flex-row items-center">
              ...
              <a class="font-bold text-gray-600 text-sm" href="{{ route('posts.index', auth()->user()->username) }}">
                Hola:
                <span class="font-normal" id="username">
                  {{ auth()->user()->username }}
                </span>
              </a>
